...
public class SetBrightnessBlock extends TranslatorBlock
{

	public SetBrightnessBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		TranslatorBlock brightness = this.getRequiredTranslatorBlockAtSocket(0);

		String ret = ht1632Name + ".setBrightness(" + brightness.toCode() + ");\n";
