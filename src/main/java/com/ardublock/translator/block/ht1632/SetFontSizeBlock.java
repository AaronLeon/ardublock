...
public class SetFontSizeBlock extends TranslatorBlock
{

	public SetFontSizeBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		TranslatorBlock size = this.getRequiredTranslatorBlockAtSocket(0);

		String ret = ht1632Name + ".setTextSize(" + size.toCode() + ");\n";
