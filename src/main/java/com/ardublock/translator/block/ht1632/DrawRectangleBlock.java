...
public class DrawRectangleBlock extends TranslatorBlock
{

	public DrawRectangleBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String ret = ht1632Name + ".drawRect(" + x1.toCode() + "," + y1.toCode() + "," + height.toCode() + "," + width.toCode() + ",1);\n";
