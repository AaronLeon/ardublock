...
public class FillCircleBlock extends TranslatorBlock
{

	public FillCircleBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String ret = ht1632Name + ".fillCircle(" + x.toCode() + "," + y.toCode() + "," + radius.toCode() + ",1);\n";
