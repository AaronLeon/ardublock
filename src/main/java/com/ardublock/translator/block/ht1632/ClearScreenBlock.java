...
public class ClearScreenBlock extends TranslatorBlock
{

	public ClearScreenBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String ret = ht1632Name + ".clearScreen();\n";
