...
public class DrawCircleBlock extends TranslatorBlock
{

	public DrawCircleBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		TranslatorBlock radius = this.getRequiredTranslatorBlockAtSocket(2);

		String ret = ht1632Name + ".drawCircle(" + x.toCode() + "," + y.toCode() + "," + radius.toCode() + ",1);\n";
